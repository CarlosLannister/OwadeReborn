...
from owade.fileAnalyze.creddump.win32.hashdump import get_bootkey
from owade.fileAnalyze.creddump.win32.lsasecrets import get_secret_by_name,get_lsa_key
