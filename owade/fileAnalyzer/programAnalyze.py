...
from owade.fileAnalyzer.historyFirefox import GetFirefoxHistory
from owade.fileAnalyzer.chrome import GetChromePasswords
from owade.fileAnalyzer.historyChrome import GetChromeHistory
from owade.hashcatLib.pwdump import PwDump
from owade.fileAnalyzer.firefox import GetFirefoxPasswords
from owade.fileAnalyzer.wifi import GetWifiPassword
from owade.fileAnalyzer.outlook import GetOutlookPassword
import datetime
import shutil
    ...
    def run(self):
        ...
        for folder in folders:
            if self.hardDrive.serial in folder:  # check if harddrive is in the folder's name
                ...
                self.internLog_.addLog("Finish analyze files", 1)
