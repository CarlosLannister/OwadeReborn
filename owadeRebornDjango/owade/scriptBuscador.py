...
class Extrator(Paths):
                    ...
                    for entryObject in directoryObject:
                        ...
                        if userDir != '.' and userDir != '..':  # Quit . and .. directories
                            ...
                            if done:
                                ...
                                self.getChromeHistory(myPath, userDir, filesystemObject)
                                self.getFirefoxKeys(myPath, userDir,filesystemObject)   # Try to get firefox passwords' database from each user (must have the masterkey for that user)
                                self.getFirefoxHistory(myPath, userDir,filesystemObject)  # Try to get firefox history database from each user (must have the masterkey for that user)
    ...
    def getChromeHistory(self,myPath,userDir, filesystemObject):
    ...
    def HistoryObj(self,myPath):
        history = ''
        #https://github.com/OsandaMalith/ChromeFreak/blob/master/ChromeFreak.py
        try:
